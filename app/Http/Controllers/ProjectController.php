...
class ProjectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $sortField = $request->input('sort_field', 'created_at'); //created_at is default value if there is no any sort_field in url
    ...
    public function store(StoreProjectRequest $request)
    {
        ...
        if ($image) {
            $data['image_path'] =  $image->store('project/' . Str::random(), 'public'); //create a path project/random string  in public folder  and return image path
        }
